			...
			<div class="container">
				...
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						...
						@else
							<li><a href="{{route('Register')}}">Đăng ký</a></li>
								...
								<div class="beta-dropdown cart-body">
									...
									<div class="cart-caption">
										...
										<div class="center">
											...
											<a href="{{route('dathang')}}" class="beta-btn primary text-center">
												xem giỏ hàng <i class="fa fa-chevron-right"></i>
											</a>
										</div>
									</div>
								</div>
		...
		<div class="header-bottom" style="background-color: #0277b8;">
			<div class="container">
				...
				<ul class="l-inline ov">
					...
					<li><a href="#">Loại Sản phẩm</a>
						<ul class="sub-menu">
							@foreach($loai_sp as $loai)
								<li><a href="{{ route('loai-san-pham', ['id' => $loai->id]) }}">{{ $loai->name }}</a></li>
							@endforeach
						</ul>
					</li>
